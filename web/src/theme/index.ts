...
const colors = {
  ...
  shadows: {
    ...
    cardLg:
      '0 5rem 14rem 0 rgb(255 255 255 / 15%), 0 0.8rem 2.3rem rgb(0 0 0 / 30%), 0 0.2rem 0.3rem rgb(0 0 0 / 23%)'
  },
  layout: {
    general: {
      bodyBg: '#F6F6F6'
  ...
  primary: {
    ...
    dark: lighten(themeColors.primary, 0.3)
  },
  success: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: {
          ...
          ':focus': {
            boxShadow: `${alpha('#000', 0.1)} 0 0 0 0.15rem`
          },
          '&.Mui-disabled': {
            backgroundColor: 'rgba(41, 41, 41, 0.04)'
          }
        },
        endIcon: {
          marginRight: -8
    ...
    MuiTooltip: {
      styleOverrides: {
        tooltip: {
          ...
          padding: '8px 16px',
          boxShadow: '0px 8px 16px rgba(31, 34, 52, 0.2)',
          borderRadius: '16px'
        },
        arrow: {
          opacity: 0
