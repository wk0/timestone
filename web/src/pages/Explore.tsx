import { Box, Container, Typography, Grid, useTheme, useMediaQuery, Chip, Button, Tabs, Tab } from '@mui/material';
      ...
      >
        ...
        >
          ...
          <Grid container justifyContent="space-between" sx={{ mt: (isMobile) ? 2 : 0 }} alignItems="center">
            ...
            <Grid item>
              <Grid container justifyContent="flex-start" spacing={3} alignItems="center">
                {searchTerm && searchTerm.length > 0 && (
                  <Grid item>
                    <Chip label={searchTerm} variant="outlined" onDelete={handleDelete} style={{ marginTop: '10px' }} />
                  </Grid>
                )}
                {isMobile && (
          ...
          <Box sx={{ width: '100%', mt: 6 }}>
            <Typography>TODO: Gallery Cards</Typography>
          </Box>
        </Container>
      </Box>
  );
