          ...
          <Grid container>
            ...
            <Box display="flex" sx={{ textAlign: "left" }}>
              <svg style={{ width: '450px', marginRight: '20px', marginRight: '20px', marginTop: '67px', marginBottom: '0px' }} width="288" height="288" viewBox="0 0 288 288" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="144" cy="141" r="102.5" stroke="#28ED9E" stroke-width="51"/>
                </g>
                <g id="time-logo">
                ...
                <defs>
                <filter id="filter0_d_41_1611" x="0" y="0" width="288" height="288" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
